...
def seed_db(db):
    ...
    flask = Tag('Flask', bg='#0d6efd')
    dbs = Tag('Postgress', bg='#6c757d')
    html = Tag('HTML/CSS', bg='#ffc107')
    django = Tag('Django', bg='#dc3545')
    api = Tag('API', bg='#198754')
    php = Tag('PHP', bg='#0dcaf0')
    js_stack = Tag('JS', bg='light')
    scraping = Tag('Web-scraping', bg='#212529')
